                ...
                <div className="flex items-start space-x-3 pt-1 w-full">
                  ...
                  <div className="space-y-1 flex-1">
                    <div className="flex items-center justify-between gap-4">
                      <Label
                        htmlFor={task.id}
                        className={`text-sm font-medium leading-none cursor-pointer ${isChecked ? 'text-muted-foreground line-through decoration-muted-foreground/50' : isMissed ? 'text-warning font-semibold' : ''
                          }`}
                      >
                        {task.label}
                      </Label>
